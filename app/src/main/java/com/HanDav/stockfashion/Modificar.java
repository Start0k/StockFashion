...
public class Modificar extends AppCompatActivity implements GestionProductoAdapter.OnProductoInteractionListener {
            ...
            if (!nuevaCantidadStr.isEmpty()) {
                try {
                    ...
                    db.collection("productos").document(producto.getId())
                            ...
                            .addOnSuccessListener(aVoid -> Toast.makeText(Modificar.this, "Cantidad actualizada", Toast.LENGTH_SHORT).show())
                            .addOnFailureListener(e -> Toast.makeText(Modificar.this, "Error al actualizar", Toast.LENGTH_SHORT).show());
                ...
                .setPositiveButton("Sí, Eliminar", (dialog, which) -> {
                    ...
                    db.collection("productos").document(producto.getId())
                            ...
                            .addOnSuccessListener(aVoid -> {
                                Toast.makeText(Modificar.this, "Producto eliminado", Toast.LENGTH_SHORT).show();

                            })
                            .addOnFailureListener(e -> Toast.makeText(Modificar.this, "Error al eliminar", Toast.LENGTH_SHORT).show());
                })
